                ...
                <>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: "flex", gap: 10, marginTop: 14, marginBottom: 18, flexWrap: "wrap" }}>
                      ...
                      <div style={{
                        background: (selectedComplaint.reposts || 0) >= 10 ? "#FDE7E3" : "rgba(255,255,255,0.15)",
                        color: (selectedComplaint.reposts || 0) >= 10 ? "#B42318" : "#FFFFFF",
                        padding: "8px 12px", borderRadius: 10, fontSize: 12, fontWeight: 700,
                        display: "flex", alignItems: "center", gap: 6,
                      }}>
                        {(selectedComplaint.reposts || 0) >= 10 ? <><MdLocalFireDepartment size={16} />High Public Attention</> : <><MdCampaign size={16} />Community Supported</>}
                      </div>
                    </div>
                  </div>
