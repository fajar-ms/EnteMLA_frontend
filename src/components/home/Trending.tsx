...
const styles = StyleSheet.create({
  trendingContainer: { backgroundColor: "#f5f5f5", paddingBottom: 20 },
  ...
  popupText: { color: "#fff", fontSize: 15, fontWeight: "500" },

  sectionHeader: { paddingHorizontal: 16, paddingTop: 20, paddingBottom: 12 },
  subHeading: { fontSize: 11, color: "#888", textTransform: "uppercase", letterSpacing: 1.2, marginBottom: 4 },
  ...
  // Card & Modal styles (same as before)
  complaintCard: {
    width: "48.5%",
    marginBottom: 14,
    borderRadius: 14,
  ...
  actionCount: { fontSize: 13, color: "#555", marginLeft: 4 },
  ...
  complaintSummary: { paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: "#f0f0f0", marginBottom: 12 },
  summaryTitle: { fontSize: 15, fontWeight: "700", color: "#1a1a1a", marginBottom: 6 },
  summaryDetails: { fontSize: 13, color: "#666", lineHeight: 20 },
  commentsList: { paddingBottom: 16 },
  singleComment: { flexDirection: "row", marginBottom: 14, alignItems: "flex-start" },
  commentAvatar: {
    width: 36,
    height: 36,
    borderRadius: 18,
  ...
  commentBody: { flex: 1, backgroundColor: "#f7f7f7", borderRadius: 12, padding: 10 },
  commentUserRow: { flexDirection: "row", alignItems: "center", marginBottom: 3, gap: 6 },
  commentUser: { fontSize: 13, fontWeight: "700", color: "#333" },
  officialBadge: { fontSize: 11, color: "#f59e0b", fontWeight: "700" },
  commentText: { fontSize: 13, color: "#555", lineHeight: 18 },
  noComments: { textAlign: "center", color: "#aaa", fontSize: 14, paddingVertical: 20 },
  modalFooter: {
    flexDirection: "row",
    alignItems: "center",
  ...
  sendButton: { backgroundColor: "#4f46e5", paddingHorizontal: 18, paddingVertical: 10, borderRadius: 24 },
